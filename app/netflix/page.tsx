  ...
  return (
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <Image className='absolute z-1' fill style={{ objectFit: 'cover' }} src={netflixImg} alt='property' />
        <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
          <h1 className="py-2">Netflix App</h1>
        ...
        <div className="col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl ">
          <div className="p-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-1">
              ...
              <p className="flex items-center py-2 text-gray-700"><RiRadioButtonFill className="pr-1" color="#a0522d" /> Routes</p>

              <p className="flex items-center py-2 text-gray-700"><RiRadioButtonFill className="pr-1" color="#00A693" /> IMDB API</p>
